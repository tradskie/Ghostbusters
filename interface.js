var minersAddr = "0x13b511bC21a05087B3297818f3aC3bF0b9039907"
...
function buyEggs(ref, trx, callback) {
  minersContract.methods
    .buyEggs(ref)
    .send({ value: trx, from: currentAddr })
    .then((result) => {
      callback()
    })
    .catch((err) => {
...
function calculateEggBuy(trx, contractBalance, callback) {
  minersContract.methods
    .calculateEggBuy(trx, contractBalance)
    .call()
    .then((result) => {
      callback(result)
    })
